...
func main() {
	...
	var webhookServerOpts webhook.Options
	if webhookCertPath != "" {
		setupLog.Info("Configuring webhook server TLS",
	...
	if secureMetrics {
		...
		if metricsCertPath != "" {
			setupLog.Info("Configuring metrics server TLS",
				"certPath", metricsCertPath,
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "butler-provider-nutanix.butlerlabs.dev",
	})
	if err != nil {
	...
	if err = (&controller.MachineRequestReconciler{
